...
class TestMinerShieldStateManager:
    ...
    def test_active_validators(self, shield_settings: ShieldTestSettings):
        ...
        validator1_address = Address(
            address_id='validator1_id', address_type=AddressType.IP, address='1.2.3.4', port=80
        )
        ...
        validator2_address = Address(
            address_id='validator2_id', address_type=AddressType.IP, address='2.3.4.5', port=81
        )
