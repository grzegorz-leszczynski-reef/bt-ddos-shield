...
class MinerShieldFactory:
    ...
    def load_miner_aws_address(cls, settings: ShieldSettings):
        ...
        return Address(
            address_id='miner', address_type=AddressType.EC2, address=address, port=settings.miner_instance_port
        )
    ...
    def create_aws_address_manager(
        ...
        return AwsAddressManager(
            aws_client_factory, miner_address, settings.aws_route53_hosted_zone_id, event_processor, state_manager
        )
